export const flags = ["--experimental_extras",
"--use_strict",
"--es_staging",
"--harmony",
"--harmony_shipping",
...
"--harmony_simd",
"--harmony_explicit_tailcalls",
"--harmony_do_expressions",
"--harmony_restrictive_generators",
"--harmony_regexp_named_captures",
...
"--turbo_verify_store_elimination",
"--trace_alloc",
"--trace_all_uses",
"--trace_range",
"--trace_gvn",
...
"--trace_wasm_ast_end",
"--skip_compiling_wasm_funcs",
"--wasm_break_on_decoder_error",
"--wasm_loop_assignment_analysis",
"--validate_asm",
"--dump_wasm_module",
...
"--min_progress_during_incremental_marking_finalization",
"--max_incremental_marking_finalization_rounds",
"--black_allocation",
"--concurrent_sweeping",
"--parallel_compaction",
